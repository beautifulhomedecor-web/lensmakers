...
# We will use Regex with Singleline mode to replace everything from LENS CUSTOMIZATION up to DESCRIPTION & ACCORDIONS (exclusive).
...
Write-Host "Repaired Lens block."
