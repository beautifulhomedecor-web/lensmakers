...
const HomeScreen = ({ onSelectTab, onReplaySplash, onReplayOnboarding, onOpenAuth, selectedLocation = 'Hyderabad', onOpenLocation }) => {
  ...
  return (
    <div className="screen-transition-enter" style={{ paddingBottom: 'calc(72px + env(safe-area-inset-bottom) + 24px)', background: '#FFFFFF' }}>
      ...
      {/* 1. SEAMLESS DARK HERO SECTION (Continues #FFFFFF from Top Header) */}
      <div
          ...
          {currentSlide === 0 && (
            ...
            >
              ...
              <div style={{ width: '60%', paddingRight: '10px', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                <h1 style={{ fontSize: '30px', fontWeight: '800', color: '#013E37', lineHeight: '1.15', margin: '0 0 8px 0', letterSpacing: '-0.5px' }}>
                  See the world<br />
                  in perfect <span style={{ color: '#013E37' }}>clarity</span>
                </h1>
              ...
              <div style={{ width: '40%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', zIndex: 1, position: 'relative' }}>
                <div style={{ position: 'absolute', width: '140px', height: '140px', background: 'radial-gradient(circle, rgba(1,62,55, 0.25) 0%, transparent 70%)', filter: 'blur(25px)', pointerEvents: 'none' }} />
                <svg width="130" height="70" viewBox="0 0 120 65" fill="none" style={{ filter: 'drop-shadow(0 10px 20px rgba(0,0,0,0.6))' }}>
                  ...
                  <circle cx="30" cy="32" r="19" stroke="#013E37" strokeWidth="1.5" strokeDasharray="18 8" opacity="0.8" />
                  ...
                  <path d="M20 24 L 38 38 M 80 24 L 98 38" stroke="#013E37" strokeWidth="2" opacity="0.7" strokeLinecap="round" />
                </svg>
              </div>
            </div>
          )}
          ...
          {currentSlide === 1 && (
            ...
            >
              <div style={{ width: '60%', paddingRight: '10px', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <h2 style={{ fontSize: '28px', fontWeight: '800', color: '#013E37', lineHeight: '1.1', margin: '0 0 4px 0' }}>
                  Flat 25% Off
                </h2>
                <div style={{ fontSize: '32px', fontWeight: '900', color: '#013E37', lineHeight: '1.0', marginBottom: '12px' }}>
                  ₹99/mo
                </div>
                ...
                <button
                  ...
                  style={{ background: '#013E37', color: '#000000', border: 'none', borderRadius: '999px', padding: '0 22px', height: '42px', fontSize: '13px', fontWeight: '700', display: 'inline-flex', alignItems: 'center', gap: '8px', cursor: 'pointer', boxShadow: '0 4px 16px rgba(156, 204, 101, 0.3)' }}
                >
                  <span>Join Now</span>
                  <i data-lucide="arrow-right" style={{ width: '16px', height: '16px', color: '#000000' }} />
                </button>
              ...
              <div style={{ width: '40%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', zIndex: 1, position: 'relative' }}>
                <div style={{ width: '100px', height: '100px', borderRadius: '24px', background: 'linear-gradient(135deg, rgba(132,204,22,0.2), rgba(1,62,55,0.2))', border: '1.5px solid rgba(132,204,22,0.4)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 24px rgba(0,0,0,0.4)', transform: 'rotate(6deg)' }}>
                  <span style={{ fontSize: '38px' }}>👑</span>
                  <span style={{ fontSize: '11px', fontWeight: '800', color: '#013E37', marginTop: '4px', letterSpacing: '1px' }}>VIP CLUB</span>
                </div>
              </div>
            </div>
          )}
            ...
            >
              <div style={{ width: '60%', paddingRight: '10px', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <button
                  ...
                  style={{ background: '#013E37', color: '#000000', border: 'none', borderRadius: '999px', padding: '0 22px', height: '42px', fontSize: '13px', fontWeight: '700', display: 'inline-flex', alignItems: 'center', gap: '8px', cursor: 'pointer', boxShadow: '0 4px 16px rgba(1,62,55, 0.3)' }}
                >
                  <span>Book Free</span>
                  <i data-lucide="arrow-right" style={{ width: '16px', height: '16px', color: '#000000' }} />
                </button>
              ...
              <div style={{ width: '40%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', zIndex: 1, position: 'relative' }}>
                <div style={{ width: '90px', height: '90px', borderRadius: '45px', background: 'rgba(1,62,55,0.18)', border: '2px solid rgba(1,62,55,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 25px rgba(1,62,55,0.3)' }}>
                  <i data-lucide="eye" style={{ width: '45px', height: '45px', color: '#013E37' }} />
                </div>
              </div>
            </div>
          )}
          ...
          {[0, 1, 2].map((idx) => (
            <span
              ...
              style={{
                ...
                height: '6px',
                borderRadius: '3px',
                background: currentSlide === idx ? '#013E37' : '#4A5568',
      ...
      >
        ...
        <div style={{ margin: '0 var(--screen-padding) 28px var(--screen-padding)', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '6px', background: '#FFFFFF', borderRadius: '20px', padding: '16px 4px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', border: '1px solid #F0F0F0' }}>
          {[
            { icon: 'glasses', color: '#013E37', bg: 'rgba(156, 204, 101, 0.12)', title: 'Eyeglasses', sub: 'Stylish Frames', tab: 'shop' },
            { icon: 'disc', color: '#013E37', bg: 'rgba(30, 136, 229, 0.12)', title: 'Lenses', sub: 'Premium Quality', tab: 'shop' },
            { icon: 'shield-check', color: '#013E37', bg: 'rgba(156, 204, 101, 0.12)', title: 'Blue Cut', sub: 'Screen Protection', tab: 'shop' },
            { icon: 'map-pin', color: '#013E37', bg: 'rgba(30, 136, 229, 0.12)', title: 'Store Locator', sub: 'Find Near You', tab: 'stores' }
          ].map((item, idx) => (
            <div
              key={idx}
        ...
        <div style={{ margin: '0 var(--screen-padding) 28px var(--screen-padding)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '14px', padding: '0 4px' }}>
            ...
            <span onClick={() => onSelectTab('shop')} style={{ fontSize: '13px', fontWeight: '700', color: '#013E37', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '2px' }}>
              See All &gt;
            </span>
          </div>
            ...
            {[
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                  ...
                  <span style={{ color: '#013E37', fontSize: '14px', fontWeight: '800' }}>→</span>
                </div>
              </div>
            ))}
          </div>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', zIndex: 2 }}>
            ...
            <div>
              <div style={{ fontSize: '16px', fontWeight: '800', color: '#013E37', lineHeight: '1.2', marginBottom: '4px' }}>
                Protect your eyes<br />
                from <span style={{ color: '#2196F3' }}>digital strain</span>
              </div>
              <div style={{ fontSize: '12px', color: 'rgba(1,62,55,0.5)', fontWeight: '500' }}>
                Explore our Blue Cut Lenses
              </div>
            </div>
          </div>

          <div style={{ width: '40px', height: '40px', borderRadius: '20px', background: '#FFF6DA', border: '1px solid #FFF6DA', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, zIndex: 2 }}>
            <span style={{ color: '#013E37', fontSize: '18px', fontWeight: '800' }}>→</span>
          </div>
        </div>
        ...
        <div style={{ margin: '0 var(--screen-padding) 28px var(--screen-padding)', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '6px', background: '#FFFFFF', borderRadius: '20px', padding: '18px 4px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', border: '1px solid #F0F0F0' }}>
          {[
            { icon: 'award', color: '#013E37', bg: 'rgba(156, 204, 101, 0.12)', title: 'Premium Quality', sub: 'Assured' },
            { icon: 'shield-check', color: '#3B82F6', bg: 'rgba(59, 130, 246, 0.12)', title: 'UV Protection', sub: '100%' },
            { icon: 'check-circle', color: '#013E37', bg: 'rgba(156, 204, 101, 0.12)', title: '1 Year Warranty', sub: 'On Lenses' },
      ...
      >
        <div style={{ width: '52px', height: '52px', borderRadius: '26px', background: 'rgba(1,62,55,0.18)', border: '1.5px solid rgba(1,62,55,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          <i data-lucide="eye" style={{ width: '26px', height: '26px', color: '#013E37' }} />
        </div>
        <div style={{ flex: 1, minWidth: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          ...
          <h3 style={{ fontSize: '16px', fontWeight: '700', color: '#013E37', margin: 0, lineHeight: '1.2' }}>
            Online Eye Check-Up
          </h3>
          <p style={{ fontSize: '12px', color: 'rgba(1,62,55,0.5)', lineHeight: '1.5', margin: '4px 0 0 0', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
            Book with certified optometrists from home. Get your digital prescription instantly.
          </p>
          <button
            className="btn-primary-pill"
            style={{ height: '36px', padding: '0 16px', fontSize: '12px', marginTop: '10px', width: 'fit-content', background: 'linear-gradient(135deg, #013E37, #0288D1)' }}
            onClick={() => onSelectTab('eyetest')}
          >
            Book Now — Free
          </button>
      ...
      <div className="bogo-rotating-card fade-up-item" style={{ margin: '0 var(--screen-padding) 32px var(--screen-padding)', animationDelay: '120ms' }}>
        <div className="bogo-card-inner">
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px', marginBottom: '14px' }}>
            ...
            <div>
              <h3 style={{ fontSize: '18px', fontWeight: '800', color: '#013E37', marginBottom: '4px' }}>
                Buy 1 Get 1 FREE
              </h3>
              <p style={{ fontSize: '13px', color: 'rgba(1,62,55,0.5)', lineHeight: '1.5' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
            <button
              className="btn-primary-pill"
              style={{ height: '42px', padding: '0 20px', fontSize: '14px', background: 'linear-gradient(135deg, #013E37, #A94A4A)' }}
              onClick={() => onSelectTab('shop')}
            >
              Shop the Offer →
            </button>
            <span style={{ fontSize: '11px', color: 'rgba(1,62,55,0.5)', fontStyle: 'italic' }}>
      ...
      <div className="purple-shimmer-card fade-up-item" style={{ margin: '0 var(--screen-padding) 32px var(--screen-padding)', animationDelay: '160ms' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px', position: 'relative', zIndex: 2 }}>
          <span style={{ fontSize: '12px', fontWeight: '800', color: '#013E37', letterSpacing: '1.5px' }}>
            LENS MAKERS CLUB
          </span>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '14px', position: 'relative', zIndex: 2 }}>
          <span style={{ fontSize: '28px', fontWeight: '800', color: '#013E37' }}>₹99</span>
          <span style={{ fontSize: '16px', color: 'rgba(1,62,55,0.5)', fontWeight: '500' }}>/ month</span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 2 }}>
          <button
            className="btn-primary-pill"
            style={{ height: '44px', padding: '0 22px', fontSize: '14px', background: 'linear-gradient(135deg, #013E37, #A94A4A)' }}
            onClick={() => onSelectTab('membership')}
          >
            Join Club for ₹99 →
          </button>
      ...
      >
        <div className="pulse-glow-circle">
          <i data-lucide="camera" style={{ width: '26px', height: '26px', color: '#A94A4A' }} />
        </div>
        <div style={{ flex: 1 }}>
          <h3 style={{ fontSize: '16px', fontWeight: '700', color: '#013E37', marginBottom: '4px' }}>
            Virtual Try-On
          </h3>
          <p style={{ fontSize: '12px', color: 'rgba(1,62,55,0.5)', lineHeight: '1.4', marginBottom: '10px' }}>
      ...
      <div className="fade-up-item" style={{ animationDelay: '240ms', padding: '0 var(--screen-padding)', marginBottom: '32px' }}>
        ...
        <div className="premium-special-card" onClick={() => onSelectTab('shop')}>
          <div style={{ position: 'absolute', left: 0, top: 0, width: '4px', height: '100%', borderRadius: '16px 0 0 16px', background: '#013E37' }} />
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1, minWidth: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(1,62,55,0.5)', margin: '2px 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>24K Plated Titanium • UV400</div>
              <div style={{ fontSize: '14px', fontWeight: '800', color: '#013E37', marginTop: '4px' }}>₹4,499</div>
            </div>
          </div>
        ...
        <div className="premium-special-card" onClick={() => onSelectTab('shop')}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1, minWidth: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(1,62,55,0.5)', margin: '2px 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Italian Acetate • Anti-Glare</div>
              <div style={{ fontSize: '14px', fontWeight: '800', color: '#013E37', marginTop: '4px' }}>₹3,899</div>
            </div>
          </div>
          <div style={{ height: '60px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-start', flexShrink: 0 }}>
            <span className="badge-pill badge-purple" style={{ fontSize: '10px' }}>
        ...
        <div className="premium-special-card" onClick={() => onSelectTab('shop')}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1, minWidth: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(1,62,55,0.5)', margin: '2px 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Featherweight 12g • Matte Black</div>
              <div style={{ fontSize: '14px', fontWeight: '800', color: '#013E37', marginTop: '4px' }}>₹5,299</div>
            </div>
          </div>
          <div style={{ height: '60px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-start', flexShrink: 0 }}>
            <span className="badge-pill badge-purple" style={{ fontSize: '10px' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          <div style={{ width: '52px', height: '52px', borderRadius: '16px', background: 'rgba(1,62,55,0.2)', border: '1.5px solid #013E37', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '26px', flexShrink: 0 }}>
            👁️
          </div>
          <div>
            <div style={{ fontSize: '15px', fontWeight: '900', color: '#013E37' }}>Digital Eye Prescriptions</div>
            <div style={{ fontSize: '12px', color: 'rgba(1,62,55,0.5)', marginTop: '2px' }}>Store & share OCR-scanned medical vision records</div>
          </div>
        </div>
        <button
          type="button"
          style={{ padding: '8px 14px', borderRadius: '999px', background: 'rgba(1,62,55,0.15)', border: '1px solid #013E37', color: '#013E37', fontSize: '12px', fontWeight: '800', cursor: 'pointer', whiteSpace: 'nowrap' }}
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
            ...
            <h3 style={{ fontSize: '16px', fontWeight: '700', color: '#013E37' }}>
      ...
      <div style={{ textAlign: 'center', padding: '16px var(--screen-padding) 32px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ fontSize: '12px', color: 'rgba(1,62,55,0.5)' }}>
