        ...
        <div className="screen-transition-enter">
          ...
          <div className="rx-card-cyan mb-4" style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <button
              ...
              style={{ height: '46px', background: 'linear-gradient(135deg, #A94A4A, #013E37)' }}
          ...
          <div className="glass-card-glow-green mb-4" style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                style={{ flex: 1, height: '46px', fontSize: '13px', background: 'linear-gradient(135deg, #013E37, #2E7D32)' }}
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(255,245,236,0.85)', backdropFilter: 'blur(14px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', animation: 'fadeIn 200ms ease' }}>
          <div className="glass-card-elevated" style={{ width: '100%', maxWidth: '380px', padding: '24px', border: '1.5px solid #A94A4A', animation: 'scaleUp 250ms var(--spring-bezier)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button type="button" className="btn-primary-pill" style={{ flex: 1, height: '44px', fontSize: '13px', background: 'linear-gradient(135deg, #A94A4A, #013E37)' }} onClick={handleSaveProfile}>Save Changes</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(255,245,236,0.85)', backdropFilter: 'blur(14px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', animation: 'fadeIn 200ms ease' }}>
          <div className="glass-card-elevated" style={{ width: '100%', maxWidth: '380px', padding: '24px', border: '1.5px solid #013E37', animation: 'scaleUp 250ms var(--spring-bezier)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button type="button" className="btn-primary-pill" style={{ flex: 1, height: '44px', fontSize: '13px', background: 'linear-gradient(135deg, #013E37, #0288D1)' }} onClick={() => { setShowPasswordModal(false); showToast("✓ Password changed successfully! Session secured."); }}>Update Password</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showDataModal && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(255,245,236,0.85)', backdropFilter: 'blur(14px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', animation: 'fadeIn 200ms ease' }}>
          <div className="glass-card-elevated" style={{ width: '100%', maxWidth: '380px', padding: '24px', border: '1.5px solid #013E37', animation: 'scaleUp 250ms var(--spring-bezier)' }}>
            ...
            <button type="button" className="btn-primary-pill w-100" style={{ height: '44px', fontSize: '13px', background: 'linear-gradient(135deg, #013E37, #2E7D32)' }} onClick={() => { setShowDataModal(false); showToast("✓ Privacy & analytics preferences saved."); }}>Save Preferences</button>
          </div>
        </div>
      )}
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(255,245,236,0.85)', backdropFilter: 'blur(14px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', animation: 'fadeIn 200ms ease' }}>
          <div className="glass-card-elevated" style={{ width: '100%', maxWidth: '420px', maxHeight: '75vh', display: 'flex', flexDirection: 'column', border: '1.5px solid #013E37', animation: 'scaleUp 250ms var(--spring-bezier)' }}>
            ...
            <div style={{ padding: '12px 20px', borderTop: '1px solid rgba(255,255,255,0.1)', textAlign: 'right' }}>
              <button type="button" className="btn-primary-pill" style={{ height: '40px', padding: '0 24px', fontSize: '13px', background: 'linear-gradient(135deg, #013E37, #0288D1)' }} onClick={() => setShowTermsModal(false)}>Got It</button>
            </div>
          </div>
        </div>
      )}
