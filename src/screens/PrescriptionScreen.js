    ...
    <div className="screen-transition-enter" style={{ minHeight: '100vh', paddingBottom: 'calc(72px + env(safe-area-inset-bottom) + 24px)' }}>
      ...
      {viewMode === 'list' && (
        <div style={{ padding: '16px var(--screen-padding)' }}>
          ...
          <div className="flex-between mb-3">
            ...
            <button
              type="button"
              style={{ background: 'transparent', border: 'none', color: '#A94A4A', fontSize: '15px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}
          ...
          {filteredList.length === 0 ? (
            <div className="glass-card-standard" style={{ padding: '48px 20px', textAlign: 'center', margin: '20px 0' }}>
              ...
              <button
                ...
                style={{ height: '46px', padding: '0 28px', fontSize: '14px', background: 'linear-gradient(135deg, #A94A4A, #013E37)' }}
                onClick={() => setViewMode('add')}
              >
                  ...
                  <div key={rx.id} className="rx-card-cyan" style={{ position: 'relative' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                          ...
                          {isMenuOpen && (
                            ...
                            >
                              ...
                              <button type="button" className="menu-item-btn" style={{ width: '100%', padding: '10px 14px', textAlign: 'left', background: 'transparent', border: 'none', color: '#A94A4A', fontSize: '13px', cursor: 'pointer', display: 'flex', gap: '8px' }} onClick={(e) => handleDeleteRx(rx.id, e)}>
                    ...
                    <div className="flex-between" style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '14px', alignItems: 'center' }}>
                      <button
                        ...
                        style={{ height: '38px', padding: '0 18px', fontSize: '12px', borderColor: '#A94A4A', color: '#A94A4A', fontWeight: '800' }}
                        onClick={() => {
      ...
      {viewMode === 'add' && (
        <div style={{ padding: '16px var(--screen-padding)' }}>
          ...
          <div style={{ display: 'flex', background: 'rgba(255,240,224,0.8)', borderRadius: '999px', padding: '4px', border: '1px solid rgba(255,255,255,0.15)', marginBottom: '24px' }}>
            {[
                ...
                <div className="rx-table-inset">
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                      ...
                      {/* Left Eye OS Row */}
                      <tr>
                        <td style={{ padding: '8px 4px', fontSize: '12px', fontWeight: '800', color: '#A94A4A' }}>Left Eye (OS)</td>
                        <td style={{ padding: '6px 2px' }}>
      ...
      {viewMode === 'detail' && selectedRx && (
        <div style={{ padding: '16px var(--screen-padding)' }}>
          ...
          <div className="rx-card-cyan mb-4">
            ...
            {selectedRx.scanFile && (
              <div style={{ background: 'rgba(1,62,55,0.1)', border: '1px solid rgba(1,62,55,0.3)', padding: '10px 14px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSel ? 'rgba(1,62,55,0.08)' : 'transparent',
  ...
  ', background: 'rgba(201,168,118,0.06)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                type="button"
                className="btn-primary-pill"
                style={{ flex: 1, height: '40px', fontSize: '12px', background: 'linear-gradient(135deg, #A94A4A, #013E37)' }}
                onClick={() => setViewMode('add')}
              >
                + Add New Rx Now
              </button>
          ...
          <div style={{ position: 'sticky', bottom: '16px', zIndex: 20 }}>
            <button
              type="button"
              className="btn-primary-pill w-100"
              style={{ height: '56px', fontSize: '16px', fontWeight: '900', background: 'linear-gradient(135deg, #013E37, #2E7D32)', boxShadow: '0 8px 28px rgba(67,160,71,0.5)' }}
              onClick={() => {
  ...
  ', fontFamily: 'monospace', fontSize: '12px', color: '#0B1F1C', whiteSpace: 'pre-line', lineHeight: '1.5', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                type="button"
                className="btn-primary-pill"
                style={{ flex: 1, height: '48px', fontSize: '14px', fontWeight: '800', background: 'linear-gradient(135deg, #013E37, #0288D1)' }}
                onClick={() => {
              ...
              <button
                type="button"
                className="btn-secondary-pill"
                style={{ flex: 1, height: '48px', fontSize: '14px', borderColor: '#A94A4A', color: '#A94A4A', fontWeight: '800' }}
                onClick={() => {
